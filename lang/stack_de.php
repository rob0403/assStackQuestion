...
$string['defaultprtpartiallycorrectfeedback'] = 'Deine Antwort ist teilweise korrekt.';
...
$string['htmlfragment'] = 'Du scheinst HTML-Elemente in deinem Ausdruck zu verwenden.';
...
$string['questiontext_help'] = 'Der Aufgabentext ist ein CASText. Dies ist die "Aufgabe", die der Studierenden konkret sieht. Du musst Eingabe- und Validierungsfelder in diesem Feld (und nur in diesem) unterbringen. Verwenden sie zum Beispiel `[[input:ans1]] [[validation:ans1]]`.';
...
$string['singlechargotmorethanone'] = 'Du kannst hier nur ein Zeichen eingeben.';
...
$string['stackCas_MissingStars']            = 'Anscheinend fehlen "*" Zeichen. Vielleicht meintest du {$a->cmd}.';
...
$string['Lowest_Terms']   = 'Deine Antwort enthält Brüche, die nicht vollständig gekürzt sind. Bitte kürze entsprechende Faktoren heraus und versuch es nochmal.';
$string['Illegal_floats'] = 'Deine Antwort enthält Fließkommazahlen, welche in dieser Aufgabe nicht erlaubt sind. Bitte gib die Zahlen als Brüche ein. So solltest du 1/3 und nicht 0.3333 (welche nur eine Annäherung darstellt) eingeben.';
$string['qm_error'] = 'Deine Antwort ist nicht vollständig. Bitte fülle alle Lücken in der Matrix aus.';
...
$string['TEST_FAILED']              = 'Die Antwortüberprüfung konnte nicht korrekt ausgeführt werden. Bitte kontaktiere deinen Kursleiter. ';
...
$string['ATAlgEquiv_SA_not_expression'] = 'Deine Antwort sollte ein Ausdruck und keine Gleichung/Ungleichung/Liste/Menge/Matrix sein. ';
$string['ATAlgEquiv_SA_not_matrix']     = 'Deine Anwort sollte eine Matrix sein, ist es aber nicht. ';
$string['ATAlgEquiv_SA_not_list']       = 'Deine Antwort sollte eine Liste sein, ist es aber nicht. Beachte die Syntax: In einer Liste wird die Auflistung der Elemente (jeweils durch Kommata getrennt) mit geschweiften Klammern eingeschlossen. ';
$string['ATAlgEquiv_SA_not_set']        = 'Deine Antwort sollte eine Menge sein, ist es aber nicht. Beachte die Syntax: In einer Menge wird die Auflistung der Elemente (jeweils durch Kommata getrennt) mit geschweiften Klammern eingeschlossen. ';
$string['ATAlgEquiv_SA_not_equation']   = 'Deine Anwort sollte eine Gleichung sein, ist es aber nicht. ';
$string['ATAlgEquiv_TA_not_equation']   = 'Deine Antwort ist eine Gleichung, aber der Ausdruck, mit dem verglichen wird, ist es nicht. Vielleicht hast du etwas wie "y=2*x+1" getippt, aber es sollte nur "2*x+1" eingegeben werden. ';
$string['ATAlgEquiv_SA_not_inequality'] = 'Deine Anwort sollte eine Ungleichung sein, ist es aber nicht. ';
$string['Subst']                        = 'Deine Antwort wäre richtig, wenn man die folgende Variablensubstitution vornimmt. {$a->m0} ';


$string['ATInequality_nonstrict']       = 'Deine Ungleichung sollte strikt/streng sein! ';
$string['ATInequality_strict']          = 'Deine Ungleichung sollte nicht strikt/streng sein! ';
$string['ATInequality_backwards']       = 'Deine Ungleichung ist falschherum. ';

$string['ATLowestTerms_wrong']          = 'Du musst die Brüche in deine Antwort eliminieren. ';
$string['ATLowestTerms_entries']        = 'Die folgenden Ausdrücke sind nicht vollständig gekürzt. {$a->m0} Bitte versuch es noch einmal.  ';


$string['ATList_wronglen']          = 'Deine Liste sollte {$a->m0} Elemente enthalten, sie hat aber {$a->m1}. ';
$string['ATList_wrongentries']      = 'Die roten Einträge unten sind die Falschen. {$a->m0} ';

$string['ATMatrix_wrongsz']         = 'Deine Matrix sollte die Größe {$a->m0} x {$a->m1} haben, sie ist aber vom Typ {$a->m2} x {$a->m3}. ';
$string['ATMatrix_wrongentries']    = 'Die roten Einträge unten sind die Falschen. {$a->m0} ';

$string['ATSet_wrongsz']            = 'Deine Menge sollte {$a->m0} verschiedene Elemente enthalten, sie hat aber {$a->m1} Elemente. ';
$string['ATSet_wrongentries']       = 'Die folgenden Einträge sind falsch, auch wenn sie in einer vereinfachten Form (im Vergleich zu deiner Eingabe) erscheinen. {$a->m0} ';

$string['irred_Q_factored']         = 'Der Term {$a->m0} sollte ausmultipliziert werden. ';
$string['irred_Q_commonint']        = 'Du musst noch einen gemeinsamen Faktor ausklammern. ';  // Needs a space at the end.
$string['irred_Q_optional_fac']     = 'Du könntest noch etwas vereinfachen, so kann {$a->m0} weiter faktorisiert werden. Allerdings ist dies nicht verlangt. ';

$string['FacForm_UnPick_morework']  = 'Du kannst noch etwas an dem Term {$a->m0} arbeiten. ';
$string['FacForm_UnPick_intfac']    = 'Du musst noch einen gemeinsamen Faktor ausklammern. ';

$string['ATFacForm_error_list']     = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte konktaktiere die kosmic Anwenderbetreuung.';
$string['ATFacForm_error_degreeSA'] = 'Das CAS konnte den algebraischen Grad deiner Antwort nicht ermitteln.';
$string['ATFacForm_isfactored']     = 'Deine Anwort ist faktorisiert. Gut gemacht!. ';  // Needs a space at the end.
$string['ATFacForm_notfactored']    = 'Deine Antwort ist nicht faktorisiert. '; // Needs a space at the end.
$string['ATFacForm_notalgequiv']    = 'Deine Antwort ist nicht algebraisch äquivalent zur korrekten Antwort. Du hast etwas falsch gemacht. '; // needs a space at the end.

$string['ATPartFrac_error_list']        = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte konktaktiere die kosmic Anwenderbetreuung.';
$string['ATPartFrac_true']              = '';
$string['ATPartFrac_single_fraction']   ='Deine Antwort ist ein einzelner Bruch, es muss aber ein partieller Bruch sein. ';
$string['ATPartFrac_diff_variables']    ='Verwende in deiner Antwort die Variablen aus der Aufgabenstellung!';
$string['ATPartFrac_denom_ret']         ='Schreibt man deine Antwort als einen einzelnen Bruch, so lautet der Nenner: {$a->m0}. Allerdings wäre {$a->m1} richtig. ';
$string['ATPartFrac_ret_expression']    ='Deine Antwort als einzelner Bruch lautet: {$a->m0} ';

$string['ATSingleFrac_error_list']     = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte konktaktiere die kosmic Anwenderbetreuung.';
$string['ATSingleFrac_true']           = '';
$string['ATSingleFrac_part']           = 'Deine Antwort muss ein einzelner Bruch der Form \( {a}\over{b} \) sein. ';
$string['ATSingleFrac_var']            = 'Verwende in deine Antwort die Variablen aus der Aufgabenstellung!';
$string['ATSingleFrac_ret_exp']        = 'Deine Antwort ist nicht algebraisch äquivalent zur korrekten Antwort. Du hast etwas falsch gemacht.';
$string['ATSingleFrac_div']            = 'Deine Antwort enthält Brüche innerhalb von Brüchen. Bitte vereinfache  dies zu einem einzelnen Bruch.';

$string['ATCompSquare_true']            = '';
$string['ATCompSquare_false']           = '';
$string['ATCompSquare_not_AlgEquiv']    = 'Deine Antwort scheint in der richtigen Form zu sein, ist aber nicht äquivalent zur korrekten Antwort.';
$string['ATCompSquare_false_no_summands']     = 'Das vollständige Quadrat ist von der Form \( a(\cdots\cdots)^2 + b\) wobei \(a\) und \(b\) nicht von deiner Variablen abhängen. Mehr als einer deiner Summanden scheint von der Variablen aus deiner Antwort abzuhängen.';


$string['ATInt_error_list']         = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATInt_const_int']          = 'Du musst eine Konstante bei der Stammfunktion angeben. Dies sollte eine beliebige Konstante sein und kein fester Wert.';
$string['ATInt_const']              = 'Du musst eine Konstante bei der Stammfunktion angeben. Ansonsten sieht alles richtig aus. Gut gemacht!';
$string['ATInt_EqFormalDiff']       = 'Die formale Ableitung deiner Antwort stimmt mit den Ausdruck überein, den du laut Aufgabenstellung integrieren solltest. Allerdings weicht deine Antwort signifikant von der richtigen Antwort ab (d.h. nicht nur eine unterschiedliche Konstante). Bitte frage bei deinem Kursleiter nach.';
$string['ATInt_wierdconst']         = 'Die formale Ableitung deiner Antwort stimmt mit dem Ausdruck überein, den du laut Aufgabenstellung integrieren solltest. Allerdings ist die Konstante merkwürdig. Bitte frage bei deinem Kursleiter nach.';
$string['ATInt_diff']               = 'Vermutlich hast du stattdessen abgeleitet!';
$string['ATInt_generic']            = 'Die formale Ableitung deiner Antwort sollte mit demn Ausdruck übereinstimmen, den du laut Aufgabenstellung integrieren solltest: Also {$a->m0}. Aber die Ableitung deiner Antwort nach {$a->m1} ist: {$a->m2}. Daher hast du etwas falsch gemacht!';

$string['ATDiff_error_list']        = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATDiff_int']               = 'Vermutlich hast du stattdessen integriert!';

$string['ATUnits_SA_not_expression']      = 'Deine Antwort muss eine Nummer zusammen mit Einheiten sein. Verwende keine Mengen, Listen, Gleichungen oder Matrizen.` ';
$string['ATUnits_SA_no_units']            = 'Deine Antwort muss Einheiten enthalten. ';
$string['ATUnits_SA_excess_units']        = 'Deine Antwort beinhaltet benutzte Einheiten (oder Variablen), was aber nicht sein sollte. ';
$string['ATUnits_SA_only_units']          = 'Deine Antwort muss eine Nummer zusammen mit Einheiten sein. Deine Antwort beinhaltet jedoch nur Einheiten. ';
$string['ATUnits_SA_bad_units']           = 'Deine Antwort muss Einheiten beinhalten und Du musst Multiplikation verwenden, um den Einheiten einen Wert beizumessen, z.B. <code>3.2*m/s</code>';
$string['ATUnits_SA_errorbounds_invalid'] = 'Deine Antwort enthält Fehlergrenzen. Gib in diesem Fall keine Fehlergrenzen an, sondern verwende nur die Menge und die Einheiten. ';
$string['ATUnits_incompatible_units']     = 'Deine Einheiten sind mit denen des Lehrers nicht kompatibel. ';
$string['ATUnits_compatible_units']       = 'Deine Einheiten unterscheiden sich von denen des Lehrers, aber sie sind mit diesen kompatibel. Numerische Werte werden zum Vergleich in SI-Basiseinheiten konvertiert. ';
$string['ATUnits_correct_numerical']      = 'Bitte überprüfe deine Einheiten sorgfältig. ';
...
$string['ATNumDecPlaces_NoDP']         = 'Deine Antwort muss eine Dezimalzahl sein, einschließlich eines Dezimalpunkts. ';
$string['ATNumDecPlaces_Wrong_DPs']    = 'Deine Antwort wurde auf die falsche Anzahl von Dezimalstellen gegeben.';

$string['ATNumSigFigs_error_list']        = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATNumSigFigs_NotDecimal']  = 'Deine Antwort sollte eine Dezimalzahl sein; ist sie aber nicht! ';
$string['ATNumSigFigs_Inaccurate']  = 'Die Genauigkeit deiner Antwort ist nicht korrekt. Entweder hast du das Endergebnis oder einen Zwischenwert falsch gerundet.';
$string['ATNumSigFigs_WrongDigits'] = 'Deine Antwort hat die falsche Anzahl an Dezimalstellen.. ';

$string['ATSysEquiv_SA_not_list']               = 'Deine Antwort sollte eine Liste sein; ist sie aber nicht!';
$string['ATSysEquiv_SB_not_list']               = 'Die Antwort des Kursleiters ist keine Liste. Bitte kontaktiere deinen Kursleiter.';
$string['ATSysEquiv_SA_not_eq_list']            = 'Deine Antwort sollte eine Liste von Gleichungen sein; ist sie aber nicht!';
...
$string['ATSysEquiv_SB_not_poly_eq_list']       = 'Die Antwort des Kursleiters sollte eine Liste von Polynomialgleichungen sein; ist sie aber nicht. Bitte kontaktiere deinen Kursleiter.';
$string['ATSysEquiv_SA_missing_variables']      = 'In deiner Antwort fehlen eine oder mehrere Variablen!';
$string['ATSysEquiv_SA_extra_variables']        = 'Deine Antwort enthält zuviele Variablen!';
$string['ATSysEquiv_SA_system_underdetermined'] = 'Die Gleichungen in deinem System scheinen korrekt zu sein, allerdings fehlen noch weitere.';
...
$string['studentValidation_notes']              = 'Diese Eingabe wird von STACK nicht automatisch ausgewertet. Du kannst damit Arbeiten oder Kommentare für den Lehrer aufzeichnen.';
...
$string['ATAlgEquiv_TA_not_equation'] = 'Deine Antwort ist eine Gleichung, aber der Ausdruck, mit dem verglichen wird, ist es nicht. Vielleicht hast du etwas wie "y=2*x+1" getippt, aber es sollte nur "2*x+1" eingegeben werden.';
$string['ATCompSquare_false'] = '';
$string['ATCompSquare_false_no_summands'] = 'Das vollständige Quadrat ist von der Form ( a(cdotscdots)^2 + b) wobei (a) und (b) nicht von ihrer Variablen abhängen. Mehr als eine deiner Summanden scheint von der Variablen aus ihrer Antwort abzuhängen.';
$string['ATCompSquare_not_AlgEquiv'] = 'Deine Antwort scheint in der richtigen Form zu sein, ist aber nicht äquivalent zur korrekten Antwort.';
$string['ATCompSquare_true'] = '';
$string['ATDiff_error_list'] = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATDiff_int'] = 'Vermutlich hast du stattdessen integriert!';
$string['ATFacForm_error_degreeSA'] = 'Das CAS konnte den algebraischen Grad deiner Antwort nicht ermitteln.';
$string['ATFacForm_error_list'] = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATFacForm_isfactored'] = 'Deine Anwort ist faktorisiert. Gut gemacht!.';
$string['ATFacForm_notalgequiv'] = 'Deine Antwort ist nicht algebraisch äquivalent zur korrekten Antwort. Du hast etwas falsch gemacht.';
$string['ATFacForm_notfactored'] = 'Deine Antwort ist nicht faktorisiert.';
$string['ATInequality_backwards'] = 'Deine Ungleichung ist falschherum.';
$string['ATInequality_nonstrict'] = 'Deine Ungleichung sollte strikt/streng sein!';
$string['ATInequality_strict'] = 'Deine Ungleichung sollte nicht strikt/streng sein!';
$string['ATInt_const'] = 'Du musst eine Konstante bei der Stammfunktion angeben. Ansonsten sieht alles richtig aus. Gut gemacht!';
...
$string['ATInt_EqFormalDiff'] = 'Die formale Ableitung deiner Antwort stimmt mit den Ausdruck überein, den du laut Aufgabenstellung integrieren solltest. Allerdings weicht deine Antwort signifikant von der richtigen Antwort ab (d.h. nicht nur eine unterschiedliche Konstante). Bitte frage bei deinem Kursleiter nach.';
$string['ATInt_error_list'] = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATInt_generic'] = 'Die formale Ableitung deiner Antwort sollte mit dem Ausdruck übereinstimmen, den du laut Aufgabenstellung integrieren solltest: Also {$a->m0}. Aber die Ableitung deiner Antwort nach {$a->m1} ist: {$a->m2}. Daher hast du etwas falsch gemacht!';
$string['ATInt_weirdconst'] = 'Die formale Ableitung deiner Antwort stimmt mit dem Ausdruck überein, den du laut Aufgabenstellung integrieren solltest. Die Integrationskonstante ist allerdings seltsam. Bitte frage deinen Kursleiter.';
$string['AT_InvalidOptions'] = 'Das Optionsfeld ist ungültig. {$a->errors}';
$string['ATList_wrongentries'] = 'Die rot unterstrichenen Einträge sind falsch. {$a->m0}';
$string['ATList_wronglen'] = 'Deine Liste sollte {$a->m0} Elemente enthalten, sie hat aber {$a->m1}.';
$string['ATLowestTerms_entries'] = 'Die folgenden Ausdrücke sind nicht vollständig gekürzt. {$a->m0} Bitte versuche es noch einmal.';
$string['ATLowestTerms_wrong'] = 'Du musst die Brüche in deiner Antwort eliminieren.';
$string['ATMatrix_wrongentries'] = 'Die rot unterstrichenen Einträge sind falsch. {$a->m0}';
$string['ATMatrix_wrongsz'] = 'Deine Matrix sollte die Größe {$a->m0} x {$a->m1} haben, sie ist aber vom Typ {$a->m2} x {$a->m3}.';
$string['AT_MissingOptions'] = 'Fehlende Option bei der Antwortüberprüfung.';
$string['AT_NOTIMPLEMENTED'] = 'Diese Antwortüberprüfung ist noch nicht implementiert.';
$string['ATNumDecPlaces_NoDP'] = 'Deine Antwort sollte eine Dezimalzahl mit einem Dezimalpunkt sein.';
$string['ATNumerical_SA_not_number'] = 'Deine Antwort sollte eine Dezimalzahl sein, ist es aber nicht.';
$string['ATNumerical_SA_not_set'] = 'Deine Antwort sollte eine Menge sein, ist es aber nicht. Beachte, dass Mengen als kommaseparierte Elemente zwischen geschweiften Klammern angegeben werden.';
$string['ATNumSigFigs_error_list'] = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATNumSigFigs_Inaccurate'] = 'Die Genauigkeit deiner Antwort ist nicht korrekt. Entweder hast du das Endergebnis oder einen Zwischenwert falsch gerundet.';
$string['ATNumSigFigs_NotDecimal'] = 'Deine Antwort sollte eine Dezimalzahl sein; ist sie aber nicht!';
$string['ATNumSigFigs_WrongDigits'] = 'Deine Antwort hat die falsche Anzahl an Dezimalstellen..';
$string['ATNumSigFigs_WrongSign'] = 'Deine Antwort hat das falsche Vorzeichen.';
$string['ATPartFrac_denom_ret'] = 'Schreibt man deine Antwort als einen einzelnen Bruch, so lautet der Nenner: {$a->m0}. Allerdings wäre {$a->m1} richtig.';
$string['ATPartFrac_diff_variables'] = 'Verwende in deiner Antwort die Variablen aus der Aufgabenstellung!';
$string['ATPartFrac_error_list'] = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATPartFrac_ret_expression'] = 'Deine Antwort als einzelner Bruch lautet: {$a->m0}';
$string['ATPartFrac_single_fraction'] = 'Deine Antwort ist ein einzelner Bruch, es muss aber ein partieller Bruch sein.';
$string['ATPartFrac_true'] = '';
...
$string['ATSet_wrongsz'] = 'Deine Menge sollte {$a->m0} verschiedene Elemente enthalten, sie hat aber {$a->m1} Elemente.';
$string['ATSingleFrac_div'] = 'Deine Antwort enthält Brüche innerhalb von Brüchen. Bitte vereinfache dies zu einem einzelnen Bruch.';
$string['ATSingleFrac_error_list'] = 'Die Antwortüberprüfung ist fehlgeschlagen. Bitte kontaktiere die kosmic Anwenderbetreuung.';
$string['ATSingleFrac_part'] = 'Deine Antwort muss ein einzelner Bruch der Form ( {a}over{b} ) sein.';
$string['ATSingleFrac_ret_exp'] = 'Deine Antwort ist nicht algebraisch äquivalent zur korrekten Antwort. Du hast etwas falsch gemacht.';
$string['ATSingleFrac_true'] = '';
$string['ATSingleFrac_var'] = 'Verwende in deiner Antwort die Variablen aus der Aufgabenstellung!';
$string['ATSysEquiv_SA_extra_variables'] = 'Deine Antwort enthält zu viele Variablen!';
$string['ATSysEquiv_SA_missing_variables'] = 'In deiner Antwort fehlen eine oder mehrere Variablen!';
$string['ATSysEquiv_SA_not_eq_list'] = 'Deine Antwort sollte eine Liste von Gleichungen sein; ist sie aber nicht!';
$string['ATSysEquiv_SA_not_list'] = 'Deine Antwort sollte eine Liste sein; ist sie aber nicht!';
$string['ATSysEquiv_SA_not_poly_eq_list'] = 'Eine oder mehrere Gleichungen sind keine Polynomgleichungen!';
...
$string['ATSysEquiv_SB_not_list'] = 'Die Antwort des Trainer/in ist keine Liste. Bitte kontaktiere deine/n Trainer/in.';
$string['ATSysEquiv_SB_not_poly_eq_list'] = 'Die Antwort des/der Kursleiters/in sollte eine Liste von Polynomialgleichungen sein; ist sie aber nicht. Bitte kontaktiere deine/n Trainer/in.';
$string['autosimplify'] = 'Auto-Vereinfachung';
$string['autosimplify_help'] = 'Setzt die Variable "simp" in Maxima für diesen potenziellen Rückmeldungsbaum.';
$string['autosimplify_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/CAS/Maxima.md#Simplification';
$string['booleangotunrecognisedvalue'] = 'Ungültige Eingabe.';
...
$string['checkanswertype_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Check_Type';
$string['clearthecache'] = 'Cache löschen';
$string['completetestcase'] = 'Fülle den Rest der Form aus, um einen Testfall zu erstellen';
$string['complexno'] = 'Bedeutung und Anzeige von sqrt(-1)';
$string['complexno_help'] = 'Steuert die Bedeutung und Anzeige des Symbols i und sqrt(-1)';
$string['complexno_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Options.md#sqrt_minus_one.';
$string['createtestcase'] = 'Testfall erstellen';
$string['currentlyselectedvariant'] = 'Dies ist die unten gezeigte Variante';
$string['ddl_empty'] = 'Es wurden keine Auswahlmöglichkeiten für dieses DropDown-Feld angegeben. Bitte gib welche ein (a,b,c,d)';
$string['debuginfo'] = 'Debug Info';
$string['defaultprtcorrectfeedback'] = 'Richtige Antwort, gut gemacht!';
$string['defaultprtincorrectfeedback'] = 'Falsche Antwort.';
$string['defaultprtpartiallycorrectfeedback'] = 'Deine Antwort ist teilweise korrekt.';
...
$string['expectedscore'] = 'Erwartete Punkte';
$string['FacForm_UnPick_intfac'] = 'Du musst noch einen gemeinsamen Faktor ausklammern.';
$string['FacForm_UnPick_morework'] = 'Du könntest noch etwas an dem Term {$a->m0} arbeiten.';
$string['false'] = 'Falsch';
$string['falsebranch'] = 'FALSCH-Zweig';
$string['falsebranch_help'] = 'Diese Felder kontrollieren was passiert, wenn die Antwortüberprüfung negativ ausfällt
### Mod und Punkte
...
$string['healthcheckconnectintro'] = 'Es wird versucht folgenden CAS-Text auszuwerten:';
$string['healthcheck_desc'] = 'Das <a href="{$a->link}">Funktionscheckskript</a> hilft ihnen zu überprüfen, ob die Bestandteile von STACK reibungslos funktionieren.';
$string['healthchecklatex'] = 'Überprüfe, ob LaTeX korrekt konvertiert wurde';
...
$string['insertstars_help'] = 'Wenn JA, dann wird das System automatisch * an passende Muster (strikte Syntax Einstellung) hinzufügen. Andernfalls wird ein Fehler angezeigt.';
$string['insertstars_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Insert_Stars';
$string['irred_Q_commonint'] = 'Du musst noch einen gemeinsamen Faktor ausklammern.';
$string['irred_Q_factored'] = 'Der Term {$a->m0} sollte ausmultipliziert werden.';
$string['irred_Q_optional_fac'] = 'Du könntest noch etwas vereinfachen, so kann {$a->m0} weiter faktorisiert werden. Allerdings ist dies nicht verlangt.';
$string['Lowest_Terms'] = 'Deine Antwort enthält Brüche, die nicht vollständig gekürzt sind. Bitte kürze entsprechende Faktoren heraus und versuche es nochmal.';
$string['Maxima_DivisionZero'] = 'Division durch Null.';
$string['multcross'] = 'Kreuz';
$string['multdot'] = 'Punkt';
$string['multiplicationsign'] = 'Multiplikationszeichen';
...
$string['phpvalid'] = 'V1';
$string['phpvalidatemismatch'] = '[PHP validate mismatch]';
$string['pleaseananswerallparts'] = 'Bitte beantworte alle Teile der Aufgabe.';
$string['pleasecheckyourinputs'] = 'Bitte überprüfe, ob deine Eingabe wie gewünscht interpretiert wurde.';
$string['pluginname'] = 'STACK';
$string['pluginnameadding'] = 'STACK-Frage hinzufügen';
$string['pluginnameediting'] = 'STACK-Frage bearbeiten';
$string['pluginname_help'] = 'STACK ist ein Assessmentsystem für Mathematik.';
...
$string['prtname'] = 'PRT Name';
$string['prtpartiallycorrectfeedback'] = 'Standard Feedback für teilweise richtige Antworten';
$string['prtwillbecomeactivewhen'] = 'Dieser potenzielle Rückmeldebaum wird aktiv, wenn der Teilnehmende folgendes geantwortet hat: {$a}';
$string['qm_error'] = 'Deine Antwort enthält das Fragezeichen "?", welches in Anworten nicht erlaubt ist. Bitte ersetze es mit konkreten Werten.';
$string['questiondoesnotuserandomisation'] = 'Diese Frage verwendet keine Randomisierung.';
$string['questionnotdeployedyet'] = 'Keine Varianten dieser Frage wurden bisher eingesetzt.';
$string['questionnote'] = 'Aufgabenhinweis';
$string['questionnote_help'] = 'Der Aufgabenhinweis ist ein CASText. Damit soll zwischen den verschiedenen zufälligen Versionen einer Frage unterschieden werden. Zwei Fragen sind gleich, genau dann wenn die Aufgabenhinweise gleich sind. Für die spätere Analyse ist es hilfreich sinnvolle Antworthinweise zu erstellen.';
...
$string['testcasexresult'] = 'Testfall {$a->no} {$a->result}';
$string['TEST_FAILED'] = 'Die Antwortüberprüfung konnte nicht korrekt ausgeführt werden. Bitte kontaktiere deinen Kursleiter.';
$string['TEST_FAILED_Q'] = 'Die Antworttests wurden nicht korrekt ausgeführt: Bitte Frage deinen Trainer.';
$string['testingquestion'] = 'Teste Frage {$a}';
$string['testinputs'] = 'Test-Eingaben';
$string['testoptions'] = 'Test-Optionen';
$string['testoptions_help'] = 'Dieses Feld erlaubt Antwortüberprüfung eine Option zu verwenden, z.B. eine Variable oder eine bestimmte numerische Präzision.';
...
$string['variantsselectionseed_help'] = 'Normalerweise kann dies leer gelassen werden. Falls sie aber für zwei verschiedene Aufgaben in einem Test den gleichen Random Seed verwenden wollen, schreiben sie in dieses Feld für beide Aufgaben die gleiche Zeichenkette. Die Random Seeds der beiden Aufgaben werden damit dann synchronisiert.';
$string['verifyquestionandupdate'] = 'Überprüfe den Aufgabentext und aktualisieren die Felder';
$string['youmustconfirm'] = 'Bitte bestätige hier.';
...
$string['stackCas_unencpsulated_comma'] = 'In dem eingegebenen Ausdruck erscheint ein Komma an ungewöhnlicher Stelle. Kommas werden zur Trennung von Elementen in Listen, Mengen usw. verwendet. Bitte verwende in Dezimalzahlen anstelle eines Kommas einen Dezimalpunkt.';
